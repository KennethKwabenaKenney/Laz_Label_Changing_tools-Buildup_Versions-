...
class PointCloudLabelChanger:
    ...
    def write_las(self, file_path, point_cloud):
        outfile = laspy.create(file_version="1.4", point_format=7)
        ...
        # Add more attributes based on your point cloud structure
        # For example:
        # outfile.red = point_cloud[:, 4]
        # outfile.green = point_cloud[:, 5]
        # outfile.blue = point_cloud[:, 6]
        # outfile.gps_time = point_cloud[:, 7]
        # outfile.classification = point_cloud[:, 8]
